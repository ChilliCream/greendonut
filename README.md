**As of know Green Donut is part of the [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) GraphQL server repository and therefore maintained there for easiness. GreenDonat remains as an independant product. The codebase can be found [here](https://github.com/ChilliCream/hotchocolate/tree/master/src/DataLoader).**
